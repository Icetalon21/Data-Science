...
Collaboration details: Discussed how to do logistic regression with Masao
...
Training set mean accuracy: 0.3867
Testing set mean accuracy: 0.2456
Results on digits 7 and 9 dataset using our Logistic Regression model
Training set mean accuracy: 0.4985
Testing set mean accuracy: 0.5000
Results on Boston housing price dataset using our Linear Regression model
Training set mean accuracy: 81.2784
Testing set mean accuracy: 44.4815
Results on diabetes dataset using our Linear Regression model
Training set mean accuracy: 3001.1304
Testing set mean accuracy: 1758.0815
"""
